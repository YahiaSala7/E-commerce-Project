...
function ProductDetails({ params }) {
  ...
  console.log(toString(product?.attributes?.category));
  const categoryValue = toString(product?.attributes?.category);
  useEffect(() => {
    getProductById_();
  ...
  const getProductByCategory_ = () => {
    ProdcutApis.getProductByCategory(categoryValue).then((res) => {
