  ...
  return (
    <div className="text-center sm:text-start">
      ...
      <p className="my-2 text-sm font-medium">
        ...
        <p className="text-gray-400 text-[14px]">{productInfo?.attributes?.instantDelivery ? <div className="flex items-center"><BadgeCheck className="w-5 h-5"/>available for instant delivery</div>}</p>
