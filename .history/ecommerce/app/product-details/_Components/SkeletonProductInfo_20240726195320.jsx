...
function SkeletonProductInfo() {
  return (
    <div>
      <div className="w-[300px] h-[30px] rounded-lg bg-slate-200 animate-pulse gap-1"></div>
      <div className="w-[50px] h-[30px] rounded-lg bg-slate-200 animate-pulse gap-1"></div>
