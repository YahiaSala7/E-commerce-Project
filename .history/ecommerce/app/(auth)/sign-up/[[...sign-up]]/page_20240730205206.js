  ...
  return (
    <section className="bg-white">
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        <section className="relative flex items-center h-32 bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          <img
            alt=""
            src="/background2.jpg"
          ...
          <div className="hidden lg:relative lg:block lg:p-12">
            ...
            <h2 className="mt-6 text-2xl font-bold text-priamry sm:text-3xl md:text-4xl ">
              Welcome to EpicRides
            </h2>
