  ...
  return (
    <section className="bg-white">
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        <section className="relative flex items-center h-full bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          <img
            alt=""
            src="/background2.jpg"
            className="absolute inset-0 object-cover  w-full h-[250px] sm:object-contain opacity-80"
          />
