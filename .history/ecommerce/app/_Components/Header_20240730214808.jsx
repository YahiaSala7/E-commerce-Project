    ...
    <header className="bg-white shadow-md">
      <div className="container flex items-center h-16 max-w-screen-xl gap-8 px-4 mx-auto sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-end flex-1 md:justify-between">
          ...
          <div className="block rounded bg-gray-100 p-2.5 text-gray-600 transition hover:text-gray-600/75 md:hidden relative">
            <div
              className={`absolute z-10 p-5 overflow-auto bg-gray-100 border rounded-md shadow-sm  top-[65px] h-[550px] min-w-[300px] ${
