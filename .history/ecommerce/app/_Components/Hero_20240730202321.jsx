      ...
      <div className="max-w-screen-xl px-4 py-32 mx-auto lg:flex lg:h-screen">
        <div className="max-w-xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-8">
            ...
            <button
              className="block w-full px-12 py-3 text-sm font-medium border border-gray-100 rounded shadow text-primary hover:text-secondary focus:outline-none focus:ring active:text-red-500 sm:w-auto"
