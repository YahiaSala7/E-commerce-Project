      ...
      <div className="max-w-screen-xl px-4 py-32 mx-auto lg:flex lg:h-screen">
        <div className="max-w-xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-8">
            ...
            <a
              className="block w-full px-12 py-3 text-sm font-medium border border-gray-300 rounded shadow-lg text-primary hover:text-secondary focus:outline-none focus:ring active:text-red-500 sm:w-auto"
              href="#explore">
              Explore
            </a>
          </div>
